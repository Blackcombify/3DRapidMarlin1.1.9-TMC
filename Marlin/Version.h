 ...
 */
   ...
   * version was tagged.
   */
  #define STRING_DISTRIBUTION_DATE "2018-12-30"
   ...
   */
  #define PROTOCOL_VERSION "Trigorilla V1.1"
   ...
   */
  #define DEFAULT_MACHINE_UUID "4eeec809-d8bc-48b1-b1a9-18d6a1f197d7"

  /**
   * The WEBSITE_URL is the location where users can get more information such as
   * documentation about a specific Marlin release.
   */
 #define WEBSITE_URL "http://3drapid.de"
