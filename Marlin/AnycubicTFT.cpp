...
void AnycubicTFTClass::HandleSpecialMenu()
{
  ...
  } else if (strcmp(SelectedDirectory, "<z move up 0.1>")==0) {
    SERIAL_PROTOCOLLNPGM("Special Menu: Z move Up 0.1");
    enqueue_and_echo_commands_P(PSTR("G91\nG1 Z0.1\nG90"));
  } else if (strcmp(SelectedDirectory, "<z move up 0.02>")==0) {
    SERIAL_PROTOCOLLNPGM("Special Menu: Z move Up 0.02");
    enqueue_and_echo_commands_P(PSTR("G91\nG1 Z0.02\nG90"));
  } else if (strcmp(SelectedDirectory, "<z move down 0.02>")==0) {
    SERIAL_PROTOCOLLNPGM("Special Menu: Z move Down 0.02");
    enqueue_and_echo_commands_P(PSTR("G91\nG1 Z-0.02\nG90"));
...
void AnycubicTFTClass::Ls()
{
  if (SpecialMenu) {
    switch (filenumber) {
      case 0: // First Page
        ANYCUBIC_SERIAL_PROTOCOLLNPGM("<Z move Up 0.1>");
        ANYCUBIC_SERIAL_PROTOCOLLNPGM("<Z move Up 0.1>");
        ANYCUBIC_SERIAL_PROTOCOLLNPGM("<Z move Up 0.02>");
        ANYCUBIC_SERIAL_PROTOCOLLNPGM("<Z move Up 0.02>");
        ANYCUBIC_SERIAL_PROTOCOLLNPGM("<Z move Down 0.02>");
        ANYCUBIC_SERIAL_PROTOCOLLNPGM("<Z move Down 0.02>");
        ANYCUBIC_SERIAL_PROTOCOLLNPGM("<Z move Down 0.1>");
        ANYCUBIC_SERIAL_PROTOCOLLNPGM("<Z move Down 0.1>");
        break;
